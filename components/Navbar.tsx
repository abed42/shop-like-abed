						...
						<div className="  mx-auto flex justify-between items-center px-4 py-5 sm:px-6 sm:py-4 lg:px-8 md:justify-start md:space-x-10">
							<div className=" " >
								<a href="#" className="flex">
									<span className="sr-only">Shop like abed</span>
									<h1 className="text-blue-500 font-bold text-xl">Shop like abed</h1>
								</a>
							</div>
									...
									<div className="flex items-center justify-between">
										<div>
											<img
												...
												src={"https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg" as any}
												alt="Workflow"
											/>
										</div>
										<div className="-mr-2">
